...
with resources.open_text('fyp_pkg.Database', 'CL_ITTER107.json') as jsonfile:
...
def trova_valore_per_id(id_istat, request_type):
    ...
    if (request_type == "inq"):
        with resources.open_text('fyp_pkg.Database', 'inquinamentoRegioni.json') as file:
            jsonFile = json.load(file)
    elif (request_type == "crim"):
        with resources.open_text('fyp_pkg.Database', 'criminalitaRegioni.json') as file:
            jsonFile = json.load(file)
    elif (request_type == "den"):
        with resources.open_text('fyp_pkg.Database', 'denunceProvince.json') as file:
            jsonFile = json.load(file)
    elif (request_type == "sup"):
        with resources.open_text('fyp_pkg.Database', 'superficieComuni.json') as file:
            jsonFile = json.load(file)
    elif (request_type == "idro"):
        with resources.open_text('fyp_pkg.Database', 'rischioIdrogeologicoComuni.json') as file:
            jsonFile = json.load(file)
    elif (request_type == "pop"):
        with resources.open_text('fyp_pkg.Database', 'popolazione.json') as file:
            jsonFile = json.load(file)
    elif (request_type == "spesa"):
        with resources.open_text('fyp_pkg.Database', 'spesaMediaRegioni.json') as file:
            jsonFile = json.load(file)
...
with resources.open_text('fyp_pkg.Database', 'Zone Sismiche.csv') as csvfile:
    zone_sismiche = pd.read_csv(csvfile)
